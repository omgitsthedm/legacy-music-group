...
// Abstract identity slates avoid representing generated people as the real team.
// Replace with owner-approved headshots when supplied. See PLACEHOLDERS.md.
export const engineers: Engineer[] = [
  {
    id: 'matthew',
    name: 'Matthew Medlock',
    specialty: 'Studio Owner & Manager',
    image: '/images/engineer-matthew.svg',
  ...
  },
  {
    ...
    image: '/images/engineer-wayne.svg',
  ...
  },
  {
    ...
    image: '/images/engineer-terry.svg',
...
const serviceDrafts: Service[] = [
  {
    ...
    recommendedEngineerIds: ['ray', 'wayne'],
  },
  {
    slug: 'r-and-b',
  ...
  },
  {
    ...
    recommendedEngineerIds: ['matthew'],
  },
]

const verifiedServiceCopy: Record<
  Service['slug'],
  Pick<Service, 'oneLiner' | 'intro' | 'body' | 'whatsIncluded' | 'startingPrice' | 'faqs'>
> = {
  'rap-recording': {
    oneLiner: 'Engineer-led vocal recording for rap and hip-hop projects in Deep Ellum.',
    intro:
      'Legacy offers engineer-led recording for independent rap and hip-hop artists. Bring the record, references and any session files you already have; the studio confirms the right room, engineer and workflow before your date.',
    body: [
      'Sessions can be booked with an engineer or as room-only time for experienced teams who can run the room themselves.',
      'Mixing and mastering can be scoped with the studio as a separate service or as the next stage after tracking.',
    ],
    whatsIncluded: [
      'A prepared recording room',
      'Engineer-led or room-only options',
      'Session scope confirmed before arrival',
      'Direct contact for file and delivery requirements',
    ],
    startingPrice: '$75/hr',
    faqs: [
      {
        question: 'Can I bring my own producer or engineer?',
        answer: 'Yes. Tell the studio who is coming and how you want to work so the right room setup can be confirmed.',
      },
      {
        question: 'Can mixing and mastering be added?',
        answer: 'Yes. Ask the Legacy team to scope mixing and mastering for the project before or after the recording session.',
      },
    ],
  },
  'r-and-b': {
    oneLiner: 'Vocal-focused recording for R&B artists, songwriters and producers.',
    intro:
      'Legacy records R&B vocals and production sessions with engineer-led and room-only options. Share references, personnel and the stage of the record before booking so the team can match the session to the work.',
    body: [
      'The studio can support focused vocal tracking, production work and project conversations around mixing and mastering.',
      'Exact setup, file delivery and turnaround depend on the project and are confirmed directly by Legacy.',
    ],
    whatsIncluded: [
      'A prepared vocal recording space',
      'Engineer-led or room-only options',
      'Project scope confirmed before arrival',
      'Mixing and mastering available by quote',
    ],
    startingPrice: '$75/hr',
    faqs: [
      {
        question: 'Can I stack vocals and harmonies?',
        answer: 'Yes. Tell the engineer about the arrangement and the number of songs when the session is scoped.',
      },
      {
        question: 'Can I bring a producer?',
        answer: 'Yes. Share the full session team with Legacy before the date so the room can be prepared.',
      },
    ],
  },
  podcasts: {
    oneLiner: 'Professional audio recording for podcasts and spoken-word projects.',
    intro:
      'Legacy can scope podcast and spoken-word recording around the number of participants, session length and delivery needs. Contact the studio before booking to confirm the current room setup and production options.',
    body: [
      'Share the number of speakers, whether anyone is remote and the kind of finished files you need.',
      'Editing, recurring-session and remote-guest requirements are quoted after the studio reviews the project.',
    ],
    whatsIncluded: [
      'A treated recording environment',
      'Session setup matched to the number of speakers',
      'Engineer support available',
      'Editing and delivery scoped separately',
    ],
    startingPrice: '$75/hr',
    faqs: [
      {
        question: 'Can I record remote guests?',
        answer: 'Ask the studio which remote workflows are currently supported before booking.',
      },
      {
        question: 'Is editing available?',
        answer: 'Editing can be discussed as part of the project scope. Delivery and turnaround are confirmed before work begins.',
      },
    ],
  },
  voiceover: {
    oneLiner: 'Studio recording for voiceover, narration and spoken-word projects.',
    intro:
      'Legacy can scope voiceover and narration sessions around the required format, direction workflow and delivery specifications. Contact the studio with the brief before booking.',
    body: [
      'Send the script length, technical specifications and whether a client or producer needs to direct the session remotely.',
      'The studio confirms current routing, editing and file-delivery capabilities for each project.',
    ],
    whatsIncluded: [
      'A treated vocal recording environment',
      'Engineer support available',
      'Project specifications reviewed before the date',
      'File delivery scoped to the brief',
    ],
    startingPrice: '$75/hr',
    faqs: [
      {
        question: 'Do you support remote direction?',
        answer: 'Share the required platform with Legacy so the team can confirm compatibility before the session.',
      },
      {
        question: 'What files can you deliver?',
        answer: 'Send the client or platform specification before booking and the studio will confirm the available delivery formats.',
      },
    ],
  },
  'artist-development': {
    oneLiner: 'Project strategy and creative direction for independent artists.',
    intro:
      'Legacy offers artist-development conversations for independent artists who need a clearer plan around a record, release or creative direction. The first conversation establishes fit and scope.',
    body: [
      'Artist development is separate from studio recording and does not automatically create a management or label relationship.',
      'Longer engagements are custom-scoped after the initial consultation.',
    ],
    whatsIncluded: [
      'Project and release conversation',
      'Creative-direction review',
      'Clear next-step recommendations',
      'Custom scope for longer engagements',
    ],
    startingPrice: '$99 consultation',
    faqs: [
      {
        question: 'Is this management or a record deal?',
        answer: 'No. A consultation does not create a management, label or ownership relationship.',
      },
      {
        question: 'How does pricing work?',
        answer: 'The published consultation rate is $99. Longer engagements are scoped directly with Legacy.',
      },
    ],
  },
}

export const services: Service[] = serviceDrafts.map((service) => ({
  ...service,
  ...verifiedServiceCopy[service.slug],
}))
...
// Public starting rates. Legacy confirms availability and final scope directly.
export const pricingTiers: PricingTier[] = [
  {
    name: 'With Engineer',
    price: '$75',
    unit: '/hour · 2-hour minimum',
    tagline: 'Engineer-led studio time.',
    features: [
      'Recording room prepared for the session',
      'Legacy engineer at the board',
      'Project setup confirmed before arrival',
      'Final scope confirmed by the studio',
    ],
  },
  {
    name: 'Room Only',
    price: '$45',
    unit: '/hour · 2-hour minimum',
    tagline: 'For experienced self-run teams.',
    features: [
      'Studio room without a Legacy engineer',
      'Bring your own qualified engineer',
      'Room setup confirmed before arrival',
      'Final scope confirmed by the studio',
    ],
  },
  {
    name: 'Mix & Master',
    price: '$150',
    unit: '/song starting rate',
    tagline: 'Finishing for one song.',
    features: [
      'Available after tracking or separately',
      'File requirements reviewed first',
      'Revision scope confirmed directly',
      'Delivery timing confirmed directly',
    ],
    highlighted: true,
  },
  {
    ...
    price: '$99',
    unit: '/consultation',
    tagline: 'Project and creative direction.',
    features: [
      'Project or release conversation',
      'Creative-direction review',
      'Clear next-step recommendations',
      'Longer work custom-scoped',
    ],
  },
]

// Additional public starting rates used on the pricing page.
...
export const alaCarteServices: AlaCarteService[] = [
  {
    ...
    price: 'By scope',
    description: 'Tell Legacy what you are making, who is involved and what delivery you need.',
  },
  {
    name: 'Longer engagements',
    price: 'By scope',
    description: 'Multi-session and longer artist-development work are confirmed directly.',
  },
  {
    name: 'Special setups',
    price: 'Confirm first',
    description: 'Podcast, voiceover, live-instrument and remote-direction needs are reviewed before booking.',
  },
]
...
export const pressMentions: PressMention[] = [
  {
    outlet: 'D Magazine',
    url: 'https://www.dmagazine.com/publications/d-magazine/2026/july/the-25-most-influential-dallas-recording-artists-of-the-last-25-years/',
  },
  {
    outlet: 'Dallas Observer',
    url: 'https://www.dallasobserver.com/music/deep-ellums-matthew-medlock-is-undeterred-by-shooting-at-his-recording-studio-8278683/',
  },
]
...
export const faqs: FaqItem[] = [
  {
    ...
    answer:
      'Hit Book Now anywhere on the site, choose a session type and engineer, then call or email the studio with your preferred time. The Legacy team confirms current availability directly.',
  },
  {
    category: 'Booking',
  ...
  },
  {
    ...
    answer:
      'Prime evening times can fill early. Call (214) 377-9729 for current availability, especially if you need a same-day or next-day session.',
  },
  {
    category: 'Booking',
    question: 'What is your cancellation policy?',
    answer:
      'Call the studio before booking to confirm the current cancellation, rescheduling and deposit terms for your session.',
  },
  {
    category: 'Sessions',
  ...
  },
  {
    ...
    answer:
      'Ask the studio for current parking details when your session is confirmed.',
  },
  {
    category: 'Payment',
    question: 'How do I pay?',
    answer:
      'The studio confirms current payment and deposit instructions before your session.',
  },
]
...
export const pricing = [
  ...
  { service: 'Artist Development', withEngineer: '$99 consultation', withoutEngineer: 'Custom scope' },
]
